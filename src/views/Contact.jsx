    ...
    <div
      ...
      className={
        darkMode
          ...
          : "bg-black pt-24 pt-24 text-white md:h-screen"
      }
    >
      ...
      <div
        className={
          darkMode
            ? "w-full bg-white text-black text-lg py-5 flex justify-center md:mt-0"
            : "w-full bg-black text-white text-lg py-5 flex justify-center md:mt-0"
        }
      >
        Made with
