      ...
      <FadeInSection>
        <div className="max-w-7xl mx-auto x-4 sm:px-6 lg:px-8 px-4 md:mt-0 pt-20 pb-12">
          ...
          <div className="skills-grid grid grid-cols-1 gap-8 mt-12 sm:grid-cols-3">
            {skill.map((el) => (
              <div className="skill">
                <FontAwesomeIcon icon={faAppStore} size="4x" className={darkMode ? "text-black" : "text-white"}/>
                <h3 className={darkMode ? "text-xl font-semibold mt-4 block text-black" : "text-xl font-semibold mt-4 text-white"}>
                  {el.name}
                </h3>
